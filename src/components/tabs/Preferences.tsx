...
export function Preferences({ preferences, updatePreferences }: PreferencesProps) {
  return (
    <div className="max-w-2xl space-y-8">
        ...
        {[
          ...
          >
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={preferences[id as keyof UserPreferences] as boolean}
                onChange={(e) => updatePreferences({ [id]: e.target.checked })}
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-white">Playback Settings</h3>
